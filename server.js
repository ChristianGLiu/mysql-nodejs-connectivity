/**
 *  All the contributions follow GNU General Public License
 *  The code in this project is only for study and education purpose only!
 */
...
connection.connect(function(err) {
    ...
    if (err) {
        ...
        connection.query(
            "CREATE TABLE IF NOT EXISTS CUSTOMER (id int auto_increment primary key, CUS_NAME varchar(256) NOT NULL, CUS_ADDR varchar(256) NOT NULL, CUS_LIMITS varchar(256) NOT NULL)",
            function(err, result) {
                if (err) {
                    console.log(err);
                }
